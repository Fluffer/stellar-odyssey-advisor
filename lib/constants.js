...
const ACTIVITY_RELEVANT_STATS = {
  ...
  // on those two items, listing its Cosmic Dust Bonus as a current bonus.
  // That label is about the PROFILE, not about the dust reward: measured on a
  // real expedition (Zilsynkyxbal, 2026-09-09, K star + 3 bodies + 17,956.78
  // ly = raw 18,026.78) the voyager paid 22,725 gross dust, a multiplier of
  // x1.2606 -- which is owl(14%) x premium(10%) = 1.254 and nothing else.
  // With the +54.9% cosmic dust catalyst it would have paid 35,000. So the
  // wiki formula is literal: an expedition gets NO catalyst dust bonus and
  // none of the exploring cosmic-dust skill either. Do not add
  // cosmic_dust_bonus here. (Whether the exploring_xp catalyst reaches the
  // expedition's XP is untested -- the same evidence does not cover it.)
