...
function planUnits(state) {
  ...
  const nextDroidPrice = typeof prices.droid === "number" ? prices.droid : null;
  const nextClonePrice = typeof prices.clone === "number" ? prices.clone : null;
  ...
  const droidRows = buildRows(droids, DROID_SKILLS, null);
...
module.exports = { unitStepCost, cumulativeUnitCost, unitMaxStepsAll, cloneMultiplier, cloneSkillMarginal, planUnits };
