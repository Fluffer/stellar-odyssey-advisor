...
// The order index.html loads them in: the per-view view-*.js scripts come
// before app.js, and app.js closes over the others.
const SCRIPTS = ["i18n.js", "icon-map.js", "pet-math.js", "lab-math.js",
  "base-math.js", "unit-math.js", "voyager-math.js", "craft-math.js",
  "view-gear.js", "view-units.js", "view-tech.js", "view-pets.js",
  "view-inventory.js", "view-craft.js", "view-lab.js", "view-base.js",
  "view-voyager.js", "app.js"];
const TABS = ["gear", "battle", "installs", "merges", "units", "tech", "pets",
  "inventory", "materials", "lab", "base", "voyager", "craft"];
...
function sandbox(data, opts) {
  const options = opts || {};
  // `options.storage` seeds localStorage, so a test can render a remembered
  // scenario (an emulator target, a level box) without a browser.
