...
function planBaseFromState(state, opts) {
  ...
  // Stellarium facts for the GUI's Stellarium section: what the miner
  // yields, how often, what unlocks and tiers cost, and every star's rate so
  // a base site can be compared. Amounts follow the two estimates the base
  // math already carries (see ESTIMATES in public/base-math.js).
  ...
  const stellarium = {
    ...
    perTick: plan.stellariumPerDay / ticksPerDay,
    perTickClient: plan.stellariumPerDayClient / ticksPerDay,
    perDay: plan.stellariumPerDay, perDayClient: plan.stellariumPerDayClient,
