...
// What each pet actually DOES -- the passive bonus it grants while equipped,
// which the advisor never showed. Taken from the game's own PetsPage summary
// (a switch on pet.name) so the numbers are the ones the game prints:
//
