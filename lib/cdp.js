...
async function discoverGame() {
  ...
  return {
    ...
    reason: sawCdp
      ...
      : "no debug port found (add %command% --remote-debugging-port=8788 to the Steam launch options and start the game from Steam)",
  };
}
...
module.exports = { CDP, evalInPage, READ_ALL, discoverGame, discoverGameWsUrl, fetchJson, readGameState };
